...
function mostrarFormulario() {
    const formularioContacto = document.querySelector('#formulario-flotante')
    const botonCerrar = document.querySelector('.boton-cerrar')

    console.log(formularioContacto);
    if(formularioContacto.classList.contains('hidden')){
        formularioContacto.classList.remove('hidden');

        formularioContacto.classList.add('visible');
    ...
    botonCerrar.addEventListener('click', (e) => {
        ...
        formularioContacto.classList.remove('visible');
